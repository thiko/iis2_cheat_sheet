...
\begin{figure}[h]
\centering
\subfigure[Pushout\label{fig:208}]{\includegraphics[width=0.21\textwidth]{Abbildungen/208}} \qquad \qquad \qquad
\subfigure[Pullback\label{fig:217}]{\includegraphics[width=0.20\textwidth]{Abbildungen/217}}
...
\begin{figure}[h]
\centering
\subfigure[Pushout\label{fig:209}]{\includegraphics[width=0.22\textwidth]{Abbildungen/209}} \qquad \qquad \qquad
\subfigure[Pullback\label{fig:218}]{\includegraphics[width=0.22\textwidth]{Abbildungen/218}}
\caption{Dekomposition}
\end{figure}

\begin{figure}[h]
\centering
\subfigure[Pushouts und Epis\label{fig:210}]{\includegraphics[width=0.22\textwidth]{Abbildungen/210}} \qquad \qquad \qquad
\subfigure[Pullback\label{fig:219}]{\includegraphics[width=0.22\textwidth]{Abbildungen/219}}
...
\begin{figure}[h]
\centering
\subfigure[Pushouts und extremal Epi\label{fig:211}]{\includegraphics[width=0.22\textwidth]{Abbildungen/211}} \qquad \qquad \qquad
\subfigure[Pullback\label{fig:220}]{\includegraphics[width=0.22\textwidth]{Abbildungen/220}}
\caption{Pushouts und Pullbacks}
\end{figure}

\begin{figure}[h]
\centering
\subfigure[Pushouts und extremal Epi\label{fig:212}]{\includegraphics[width=0.22\textwidth]{Abbildungen/212}} \qquad \qquad \qquad
\subfigure[Pullback\label{221}]{\includegraphics[width=0.21\textwidth]{Abbildungen/221}}
\caption{Pushouts und Pullbacks}
\end{figure}
\newpage 
...
\paragraph{\defi 264: Substitution} Given a term $t\in T^{\Sigma,X}$
...
\paragraph{\defi 265 Partial-Term-System-Atomic-Axioms} If $B$ is an algebraic system and $\Phi$ a set of
...
\paragraph{\lem 266: Partial-Term-System-Hom-Extension}If $m:B\rightarrow C$
...
\paragraph{\lem 267: Satisfaction-and-AA-Partial-Term-System}If a system $B$
satisfies a set of atomic axioms $\Phi$, i.\,e.~$B\models\Phi$,
$P_{\Phi}(B)\subseteq P(\textrm{id}_{B})$.



\paragraph{\defi 268: Self-Substitution} The \emph{self-substitution}
...
\paragraph{\defi 269: Operation Closure for Atomic
...
\paragraph{\prop 270: Embedding into Operation
...
\paragraph{\lem 271 Pushout-of-Atomic-Axioms}The pair of homomorphisms $i_{B}^{\mathsf{T}}:P_{\Phi}(B)\rightarrow B_{\mathsf{T_{\Phi}}}$
...
\paragraph{\defi 273: Predicate-Closure-for-Atomic}(Predicate Closure for Atomic
...
\paragraph{\prop 274: Embedding into Predicate
...
\paragraph{\lem 275:Predicate-Closure}If $B$ is a $\Sigma$-system, $\Phi$
...
\paragraph{\defi 276: Construction-of-the-Atomic-Reflection}(Construction of the
...
\paragraph{\lem 277:Reflection-Satisfaction}$B_{\Phi}\models\Phi$.

\paragraph{\lem 278 : Equality-Closure}If $B$ is a $\Sigma$-system, $\Phi$
...
\paragraph{\defi 281: Gültigkeit von Hormaxiomen}
...
\paragraph{\prop 282: Gültigkeit ist abstrakt}
$a = (X, P, c)$ Hornaxiom, $B \models a$, $B \approx B'$ $\implies$ $B' \models a$.


\paragraph{\prop 283: Gültigkeit Produkt und Subsystem}
$a = (X, P, c)$ Hornaxiom
\begin{enumerate}
...
\paragraph{\lem 284: \homos in approximierte Systeme}
...
\paragraph{\prop 285: Gültigkeit in  approximierten Systeme}
...
\paragraph{\defi 286: Horn-Spezifikation}
...
\paragraph{\prop 287: Hornklassen sind abstrakt}
Jede Hornklasse ist isomorph-geschlossen.

\paragraph{\defi 288: Bündel von Hornaxiomen, Lösung}
...
\paragraph{\lem 289: Bündel definieren Co-Limiten}
...
\paragraph{\prop 290: Bündel von Hornaxiomen}
...
\paragraph{\coro 291: Hornklassen sind episch reflektive Subkategorien}
